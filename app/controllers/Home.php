...
class Home extends Controller
{
    ...
    public function beli()
    {
        ...
        if (isset($_POST["beli"])) {
            ...
            $jumlah = $_POST["jumlah"];
            $ukuran = $_POST["ukuran"]; // Ambil ukuran dari form
            $produkModel = $this->model('Produk');
            ...
            if ($produk) {
                if ($jumlah <= $produk["stokproduk"]) {
                    $_SESSION["keranjang"][$idproduk] = [
                        'jumlah' => $jumlah,
                        'ukuran' => $ukuran // Tambahkan ukuran ke dalam keranjang
                    ];
    ...
    public function keranjang()
    {
        ...
        foreach ($keranjang as $idproduk => $details) {
            $produk = $produkModel->getProdukById($idproduk);
            if ($produk) {
                $produk['jumlah'] = $details['jumlah'];
                $produk['ukuran'] = $details['ukuran']; // Tambahkan ukuran
                $produk['totalharga'] = $produk['hargaproduk'] * $details['jumlah'];
                $produkList[] = $produk;
            }
        }
    ...
    public function checkout()
    {
        ...
        foreach ($_SESSION["keranjang"] as $idproduk => $details) {
            $produk = $this->model('Produk')->getProdukById($idproduk);

            if ($produk) {
                $produk['jumlah'] = $details['jumlah'];
                $produk['ukuran'] = $details['ukuran'];
                $produk['subharga'] = $produk['hargaproduk'] * $details['jumlah'];
                $produk['subberat'] = $produk['beratproduk'] * $details['jumlah'];
        ...
        if (isset($_POST["checkout"])) {
            ...
            if ($metodepengiriman == 'Reguler') {
                ...
                foreach ($_SESSION['keranjang'] as $idproduk => $details) {
                    ...
                    $penjualanQuery = "INSERT INTO penjualan (idpenjualan, idproduk, nama, harga, subharga, jumlah,ukuran)
                    VALUES ('$idpenjualan_barusan', '$idproduk', '$nama', '$harga', '$subharga', '$jumlah','$ukuran')";
